...
describe('TPDS Asset Transfer Tests', () => {
    ...
    describe('Test CreateAsset', () => {
        it('should return error on CreateAsset', async () => {
            ...
            let assetTransfer = new AssetTransfer();
            try {
                await assetTransfer.CreateAsset(transactionContext, asset.ID, asset.Quantity, asset.Owner);
    ...
    describe('Test GetAllAssets', () => {
        it('should return success on GetAllAssets', async () => {
            ...
            await assetTransfer.CreateAsset(transactionContext, 'asset1', 50, 'Central Government');
            await assetTransfer.CreateAsset(transactionContext, 'asset2', 25, 'Central Government');
            await assetTransfer.CreateAsset(transactionContext, 'asset3', 75, 'Central Government');
            await assetTransfer.CreateAsset(transactionContext, 'asset4', 60, 'Central Government');
            ...
            let expected = [
                {Record: {ID: 'asset1', Quantity: 50, Owner: 'Central Government', PrevOwners: [], State: 1, SendTime: '', ExpectedTime: '', ExpectedReceiver: ''}},
                {Record: {ID: 'asset2', Quantity: 25, Owner: 'Central Government', PrevOwners: [], State: 1, SendTime: '', ExpectedTime: '', ExpectedReceiver: ''}},
                {Record: {ID: 'asset3', Quantity: 75, Owner: 'Central Government', PrevOwners: [], State: 1, SendTime: '', ExpectedTime: '', ExpectedReceiver: ''}},
                {Record: {ID: 'asset4', Quantity: 60, Owner: 'Central Government', PrevOwners: [], State: 1, SendTime: '', ExpectedTime: '', ExpectedReceiver: ''}}
            ];
